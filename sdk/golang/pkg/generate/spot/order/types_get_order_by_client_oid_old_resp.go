...
// GetOrderByClientOidOldResp struct for GetOrderByClientOidOldResp
...
func NewGetOrderByClientOidOldResp(id string, symbol string, opType string, Type_ string, side string, price string, size string, funds string, dealFunds string, dealSize string, fee string, feeCurrency string, stp string, stop string, stopTriggered bool, stopPrice string, timeInForce string, postOnly bool, hidden bool, iceberg bool, visibleSize string, cancelAfter int32, channel string, clientOid string, remark string, tags string, isActive bool, cancelExist bool, createdAt int64, tradeType string) *GetOrderByClientOidOldResp {
	this := GetOrderByClientOidOldResp{}
	this.Id = id
	this.Symbol = symbol
	this.OpType = opType
	this.Type = Type_
...
// NewGetOrderByClientOidOldRespWithDefaults instantiates a new GetOrderByClientOidOldResp object
// This constructor will only assign default values to properties that have it defined,
func NewGetOrderByClientOidOldRespWithDefaults() *GetOrderByClientOidOldResp {
	this := GetOrderByClientOidOldResp{}
	return &this
}

func (o *GetOrderByClientOidOldResp) ToMap() map[string]interface{} {
...
func (o *GetOrderByClientOidOldResp) SetCommonResponse(response *types.RestResponse) {
