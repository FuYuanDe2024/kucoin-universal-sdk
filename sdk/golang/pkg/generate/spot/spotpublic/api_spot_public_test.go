...
func TestSpotPublicKlinesRespModel(t *testing.T) {
	// Klines
	// Klines
...
func TestSpotPublicMarketSnapshotRespModel(t *testing.T) {
	// MarketSnapshot
	// Market Snapshot
...
func TestSpotPublicOrderbookIncrementRespModel(t *testing.T) {
	// OrderbookIncrement
	// Orderbook - Increment
...
func TestSpotPublicOrderbookLevel1RespModel(t *testing.T) {
	// OrderbookLevel1
	// Orderbook - Level1
...
func TestSpotPublicOrderbookLevel50RespModel(t *testing.T) {
	// OrderbookLevel50
	// Orderbook - Level50
...
func TestSpotPublicOrderbookLevel5RespModel(t *testing.T) {
	// OrderbookLevel5
	// Orderbook - Level5
...
func TestSpotPublicSymbolSnapshotRespModel(t *testing.T) {
	// SymbolSnapshot
	// Symbol Snapshot
...
func TestSpotPublicTickerRespModel(t *testing.T) {
	// Ticker
	// Get Ticker
...
func TestSpotPublicTradeRespModel(t *testing.T) {
	// Trade
	// Trade
