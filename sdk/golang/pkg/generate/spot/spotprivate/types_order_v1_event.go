...
// OrderV1Event struct for OrderV1Event
type OrderV1Event struct {
	// common response
...
// NewOrderV1Event instantiates a new OrderV1Event object
// This constructor will assign default values to properties that have it defined
func NewOrderV1Event(clientOid string, orderId string, orderTime int64, orderType string, originSize string, side string, status string, symbol string, ts int64, Type_ string) *OrderV1Event {
	this := OrderV1Event{}
...
// NewOrderV1EventWithDefaults instantiates a new OrderV1Event object
// This constructor will only assign default values to properties that have it defined,
func NewOrderV1EventWithDefaults() *OrderV1Event {
	this := OrderV1Event{}
	return &this
}

func (o *OrderV1Event) ToMap() map[string]interface{} {
...
type OrderV1EventCallback func(topic string, subject string, data *OrderV1Event) error

type OrderV1EventCallbackWrapper struct {
	callback OrderV1EventCallback
}

func (w *OrderV1EventCallbackWrapper) OnMessage(msg *types.WsMessage) error {
	obj := &OrderV1Event{}
