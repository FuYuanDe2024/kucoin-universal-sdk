...
func TestMarketGetAnnouncementsReqModel(t *testing.T) {
	// GetAnnouncements
	// Get Announcements
	...
	req := &GetAnnouncementsReq{}
	err := json.Unmarshal([]byte(data), req)
	req.ToMap()
	assert.Nil(t, err)
}

func TestMarketGetAnnouncementsRespModel(t *testing.T) {
	// GetAnnouncements
	// Get Announcements
	// /api/v3/announcements
...
func TestMarketGetCurrencyReqModel(t *testing.T) {
	// GetCurrency
	// Get Currency
...
func TestMarketGetCurrencyRespModel(t *testing.T) {
	// GetCurrency
	// Get Currency
	// /api/v3/currencies/{currency}
...
func TestMarketGetAllCurrenciesReqModel(t *testing.T) {
	// GetAllCurrencies
	// Get All Currencies
	// /api/v3/currencies
...
func TestMarketGetAllCurrenciesRespModel(t *testing.T) {
	// GetAllCurrencies
	// Get All Currencies
	// /api/v3/currencies
...
func TestMarketGetFiatPriceRespModel(t *testing.T) {
	// GetFiatPrice
	// Get Fiat Price
	// /api/v1/prices
...
func TestMarketGetMarketListReqModel(t *testing.T) {
	// GetMarketList
	// Get Market List
	// /api/v1/markets
...
func TestMarketGetMarketListRespModel(t *testing.T) {
	// GetMarketList
	// Get Market List
	// /api/v1/markets
